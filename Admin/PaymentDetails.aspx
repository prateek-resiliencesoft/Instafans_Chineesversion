<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="PaymentDetails.aspx.cs" Inherits="Social_Media_Service_Panel.Admin.PaymentDetails" %>
  ...
  <%--<link href="../Styles/Jqx/jqx.base.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetPaymentDetailsForAdmin",
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Payment Details</h2>
                    <div class="box-icon">
