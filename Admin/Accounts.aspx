<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="Accounts.aspx.cs" Inherits="SocialPanel.Admin.Accounts" %>
...
<%--<link href="../Styles/Jqx/jqx.base.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetAccounts",
                    ...
                    $("#jqxgrid").jqxGrid(
            {
               ...
               rowsheight:30,
                ...
                columns: [
                    ...
                    { text: 'Password', datafield: 'Password', width: 130 },
