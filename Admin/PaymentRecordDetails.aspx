<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="PaymentRecordDetails.aspx.cs" Inherits="Social_Media_Service_Panel.Admin.PaymentRecordDetails" %>
...
--%>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetPaymentRecordDetailsForAdmin",
...
//                    { name: 'UpdatedBy', type: 'string' },
                    ...
                    $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Status', datafield: 'Status', width: 90, cellsrenderer: statusRender },
                    { text: 'Payment Date', datafield: 'PaymentDate', width: 100, cellsformat: 'd' },
//                    { text: 'Updated Date', datafield: 'PaymentUpdatedDate', width: 100, cellsformat: 'd' },
                    { text: 'Transaction Id', datafield: 'TransactionId', width: 160 },
                    { text: 'Payer Email', datafield: 'PayerEmail', width: 230 },
                    { text: 'Receiver Email', datafield: 'ReceiverEmail', width: 250 }
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Payment Records</h2>
                    <div class="box-icon">
