<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Social_Media_Service_Panel.Admin.Users" %>
...
--%>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetAllUsers",
                    ...
                    var source =
            {
                ...
                updaterow: function (rowid, rowdata, commit) {
                    ...
                    var editOrder = function (row, column, value, defaultHtml) {
                        ...
                        return '<a class="btn btn-info" href="/Admin/User.aspx?id=' + dataRecord.Username + '" target="_blank"><i class="icon-edit icon-white"></i>Edit</a>'
                    }
