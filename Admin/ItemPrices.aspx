<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="ItemPrices.aspx.cs" Inherits="SocialPanel.Admin.ItemPrices" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetOrderTypePriceDetailsForAdmin",
                    ...
                    var source =
            {
                ...
                updaterow: function (rowid, rowdata, commit) {
                    ...
                    var editOrder = function (row, column, value, defaultHtml) {
                        ...
                        //return '<a href="/Admin/ItemPrice.aspx?id=' + dataRecord.Id + '" target="_blank"/>Edit</a>'
                        return '<a class="btn btn-info" href="/Admin/ItemPrice.aspx?id=' + dataRecord.Id + '" target="_blank"><i class="icon-edit icon-white"></i>Edit</a>'
                    }
                    ...
                    $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'OrderType', datafield: 'OrderType', width: 200 },
                    { text: 'Price', datafield: 'Price', width: 130, aggregates: ['sum'] },
                     { text: 'Min Account', datafield: 'MinAmount', width: 140 },
                      { text: 'Max Account', datafield: 'MaxAmount', width: 150 }
                ]
            });
