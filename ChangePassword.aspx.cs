...
//string pass = Membership.Provider.GetPassword(HttpContext.Current.User.Identity.Name, "answer");
//var Name = Membership.GetUser(HttpContext.Current.User.Identity.Name, false);
