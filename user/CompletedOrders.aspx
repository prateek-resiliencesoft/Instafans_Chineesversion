<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site.Master" AutoEventWireup="true" CodeBehind="CompletedOrders.aspx.cs" Inherits="SocialPanel.User.CompletedOrders" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../JquerPost.aspx/GetNormalCompletedOrdersForUser",
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Completed Orders</h2>
                    <div class="box-icon">
