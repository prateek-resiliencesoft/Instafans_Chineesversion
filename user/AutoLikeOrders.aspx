<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site.Master" AutoEventWireup="true" CodeBehind="AutoLikeOrders.aspx.cs" Inherits="SocialPanel.User.AutoLikeOrders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetAutoLikeNonCompletedOrdersForUser",
                    ...
                    $("#jqxgrid").jqxGrid(
            {
                ...
                //                    { text: 'Edit', datafield: 'Edit', width: 50, cellsrenderer: editOrder },
                    {text: 'OrderId', datafield: 'OrderId', width: 70 },
                    { text: 'Order Type', datafield: 'OrderType', width: 200 },
                    { text: 'Url', datafield: 'Url', width: 270, cellsrenderer: hrefUrl },
                    { text: 'Amount', datafield: 'Amount', width: 70, aggregates: ['sum'] },
                    { text: 'Order Date', datafield: 'OrderDate', width: 160, cellsformat: 'M/d/yyyy h:mm:ss tt' },
                    { text: 'Start', datafield: 'StartPoint', width: 60 },
                    { text: 'End', datafield: 'EndPoint', width: 60 },
                    { text: 'Status', datafield: 'OrderStatus', width: 80, cellsrenderer: statusRender },
...
<div id="content" class="span10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li><a href="#">Auto Like Orders</a> </li>
            </ul>
        </div>
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Auto Like Orders</h2>
                    <div class="box-icon">
