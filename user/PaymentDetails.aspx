<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site.Master" AutoEventWireup="true" CodeBehind="PaymentDetails.aspx.cs" Inherits="Social_Media_Service_Panel.User.PaymentDetails" %>
 ...
 <%-- <link href="../Styles/Jqx/jqx.base.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "../JquerPost.aspx/GetPaymentDetailsForUser",
                    ...
                    $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Amount', datafield: 'Amount', width: 250 },
                    { text: 'DateTime', datafield: 'DateTime', width: 450}
                    ] 
                     });
