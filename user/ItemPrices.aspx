<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site.Master" AutoEventWireup="true" CodeBehind="ItemPrices.aspx.cs" Inherits="SocialPanel.User.ItemPrices" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
                    ...
                    $("#jqxgrid").jqxGrid(
            {
                ...
                //                },
                columns: [
//                    { text: 'Edit', datafield: 'Edit', width: 50},
